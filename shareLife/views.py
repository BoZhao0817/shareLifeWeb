        ...
        if not request.user.is_authenticated:
            ...
            if form.is_valid():  # 如果提交的数据合法
                ...
                p = Post(name=name, body=body,
                        created_time=timezone.now(), modified_time=timezone.now(), author=request.user,pic_url ="https://a0.muscache.com/im/pictures/3423348/5d067377_original.jpg?aki_policy=large")
                p.save()
